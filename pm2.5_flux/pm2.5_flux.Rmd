...
```{r}
# create new dataframe extracting just the wind speed and precipitation with hours
...
narrows_windspeed <- narrows_date_tidy %>% 
  ...
  summarize(mean_hourly_windspeed = mean(hourly_wind_speed),
            mean_hourly_precip = mean(hourly_precipitation))
```
